...
function DhyanChallenge21() {
  ...
  const days = [
    {
      day: 1,
      title: "Sankalpa (Sacred Intention)",
      phase: "Foundation",
      practices: [
        "5 min deep breathing",
        "10 min guided body awareness",
        "Write your 21-day intention",
        "Practice: Sit still without movement",
      ],
      mantra: "Om Tat Sat",
      mantraNote: "",
    },
    {
      ...
      practices: [
        ...
        "12 min observing natural breath",
        "Notice inhale/exhale length",
      ],
      mantra: "So Hum",
      mantraNote: "Inhale: So — Exhale: Hum",
    },
    {
      day: 3,
      ...
      phase: "Foundation",
      practices: [
        "Learn stable seated posture",
        "15 min still sitting",
        "Avoid adjusting body",
      ],
    ...
    },
    {
      ...
      phase: "Foundation",
      practices: [
        "Count inhale–exhale cycles up to 21",
    ...
    },
    {
      ...
      mantra: "Om Sakshi Bhavaya Namah",
      mantraNote: "",
    },
    {
      day: 7,
      ...
      phase: "Foundation",
      practices: [
        "20 min combined practice",
        "Evening reflection journaling",
      ],
      mantra: "Silent Meditation",
      mantraNote: "No mantra today — rest in pure silence",
    },
    {
      day: 8,
      title: "Mantra Introduction",
      phase: "Deepening",
      practices: [
        "Soft chanting of Om",
        "15 min mantra meditation",
      ],
    ...
    },
    {
      ...
      phase: "Deepening",
      practices: [
        "Visualize light in heart center",
    ...
    },
    {
      ...
      practices: [
        ...
        "No counting or mantra",
      ],
      mantra: "Mental OM Awareness",
      mantraNote: "Silently feel the vibration of OM within",
    },
    {
      day: 11,
      ...
      practices: [
        "5 min candle gazing",
        "10 min closed-eye focus",
      ],
      mantra: "Om Jyotir Namah",
      mantraNote: "",
    },
    {
      day: 12,
    ...
    },
    {
      ...
      phase: "Deepening",
      practices: [
        "5 min gratitude breathing",
        "15 min silent sitting",
      ],
      mantra: "Om Krutagyaya Namah",
      mantraNote: "",
    },
    {
      day: 14,
      title: "Deep Pranayama",
      phase: "Deepening",
      practices: [
        "5 min Nadi Shodhana",
        "15 min meditation",
    ...
    {
      day: 15,
      title: "Longer Silence",
      phase: "Mastery",
      practices: [
        "25 min meditation",
        "Self-led discipline",
      ],
      mantra: "Om (Long Chant)",
      mantraNote: "Sustain the OM for as long as each breath allows",
    },
    {
      day: 16,
      ...
      phase: "Mastery",
      practices: [
        "Observe body, breath, and thoughts",
        "Remain neutral observer",
      ],
      mantra: "Om Sakshi",
      mantraNote: "",
    },
    {
      day: 17,
      title: "Inner Sound Awareness",
      phase: "Mastery",
      practices: [
        "Listen to subtle inner sounds",
        "Stay in deep silence",
      ],
      mantra: "Silent Inner OM Listening",
      mantraNote: "No chanting — only listening to the inner vibration",
    },
    {
      day: 18,
      title: "Kundalini Awareness",
      phase: "Mastery",
      practices: [
        "Spine awareness breathing",
        "Visualize rising energy gently",
      ],
    ...
    },
    {
      ...
      mantra: "Om Vairagyaya Namah",
      mantraNote: "",
    },
    {
      day: 20,
      title: "Extended Stillness (30 Minutes)",
      phase: "Mastery",
      practices: [
        "Deep uninterrupted silence",
        "Avoid checking time",
      ],
      mantra: "Om Param Shantaye Namah",
      mantraNote: "",
    },
    {
      day: 21,
      ...
      phase: "Mastery",
      practices: [
        "30 min full practice",
        "Reflect on transformation",
        "Write future daily meditation plan",
      ],
      mantra: "Om Purnamadah Purnamidam",
      mantraNote: "Purnat Purnamudachyate · Purnasya Purnamadaya · Purnamevavashishyate",
    },
  ];
  ...
  const completionBenefits = [
    { icon: "🧘", title: "Strong Meditation Habit", description: "A daily practice rooted in discipline, not motivation." },
    { icon: "🧠", title: "Improved Concentration", description: "The mind trained to rest, not wander." },
    { icon: "⚖️", title: "Emotional Balance", description: "Feelings observed, not controlled by." },
    { icon: "🌬️", title: "Breath Control", description: "Pranayama as a daily tool for nervous system regulation." },
    { icon: "🌱", title: "Spiritual Grounding", description: "A deeper, lived connection to your inner self." },
  ];
    ...
    <div className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroSplit}>
          ...
          <div className={styles.heroLeft}>
            <h1 className={styles.heroTitle}>21-Day Dhyān Challenge</h1>
            <p className={styles.heroSubtitle}>
              Twenty-one days of guided meditation to transform your consciousness
              and cultivate <em>lasting stillness.</em>
            </p>
            <button className={styles.btnJoinHero} onClick={() => document.getElementById("schedule").scrollIntoView({ behavior: "smooth" })}>
              View Full Schedule
            </button>
          </div>
          {/* Right — image */}
          <div className={styles.heroRight}>
            <div className={styles.heroImageOverlay}
              style={{ background: `linear-gradient(to right, #422868 0%, #42286899 18%, transparent 50%)` }}
            />
            <img
      ...
      <section className={styles.phasesSection}>
        <div className={styles.container}>
          <p className={styles.eyebrowCenter}>How the 21 Days Are Structured</p>
          <h2 className={styles.sectionTitle}>Three Phases of <span className={styles.purple}>Transformation</span></h2>
          <div className={styles.phasesGrid}>
            {phases.map((phase) => (
              <div key={phase.name} className={styles.phaseCard} style={{ borderTop: `3px solid ${phase.color}` }}>
                <span className={styles.phaseDays} style={{ color: phase.color }}>{phase.days}</span>
      ...
      {/* ── 21-Day Schedule + Mantra ── */}
      <section className={styles.scheduleSection} id="schedule">
        <div className={styles.container}>
          <p className={styles.eyebrowCenter}>Daily Practice Guide</p>
          <h2 className={styles.sectionTitle}>The Complete <span className={styles.purple}>21-Day Schedule</span></h2>
      ...
      <section className={styles.musicSection}>
        <div className={styles.container}>
          ...
          <h2 className={styles.sectionTitle}>Background Music <span className={styles.purple}>Structure</span></h2>
          <p className={styles.sectionSubtitle}>
          ...
          <div className={styles.musicLayersGrid}>
            ...
            <div className={styles.musicLayerCard}>
              ...
              <p className={styles.musicLayerDesc}>
                ...
                This layer carries the day's assigned mantra at low volume beneath the breath.
              </p>
            </div>
          </div>
      ...
      <section className={styles.completionSection}>
        <div className={styles.container}>
          ...
          <h2 className={styles.sectionTitle}>After <span className={styles.purple}>21 Days</span></h2>
          <p className={styles.sectionSubtitle}>
